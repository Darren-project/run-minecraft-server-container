...
RUN mkdir minecraft && cd minecraft && wget https://api.purpurmc.org/v2/purpur/1.16.5/1171/download && mv download server.jar && ls && cd .. && wget https://raw.githubusercontent.com/mickeydarrenlau/run-minecraft-server-container/master/eula.txt && mv eula.txt minecraft/eula.txt && wget https://raw.githubusercontent.com/mickeydarrenlau/run-minecraft-server-container/master/minecraft/server.properties && mv server.properties minecraft/server.properties
WORKDIR minecraft
