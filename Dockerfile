...
RUN cd /tmp && wget https://www.python.org/ftp/python/3.8.3/Python-3.8.3.tgz && tar -xf Python-3.8.3.tgz && cd python-3.8.3 && ./configure --enable-optimizations && make altinstall
