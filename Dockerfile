...
RUN mkdir minecraft && cd minecraft && wget https://papermc.io/api/v2/projects/paper/versions/1.16.5/builds/794/paper-1.16.5-794.jar && mv paper-1.16.5-794.jar paper.jar && ls
WORKDIR minecraft
